...
public class JavascriptExecutor1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebDriver driver= new ChromeDriver();
		 ...
		 System.out.println("Attribute value is1: " + strValue);
		 
         String strValue1 = driver.findElement(By.className("gsc-input")).getAttribute("type");
		 
		 System.out.println("Attribute value is2: " + strValue1);
